...
final class SearchAPIClient {
    static func getVenue(latitude: String, longitude: String, category: String, completionHandler: @escaping(AppError?, [VenueStruct]?) -> Void) {
        let URL = "https://api.foursquare.com/v2/venues/search?client_id=\(SecretKeys.yazID2)&client_secret=\(SecretKeys.yazSecret2)&v=20180323&ll=\(latitude),\(longitude)&query=\(category)"
