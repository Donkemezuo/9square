...
final class SearchAPIClient {
    static func getVenue(latitude: String, longitude: String, category: String, completionHandler: @escaping(AppError?, [VenueStruct]?) -> Void) {
        ...
        let URL = "https://api.foursquare.com/v2/venues/search?client_id=\(SecretKeys.jane2ID)&client_secret=\(SecretKeys.jane2Secret)&v=20180323&ll=\(latitude),\(longitude)&query=\(category)"
